...
if (url.includes("/x/resource/show/skin")) {
  ...
  if (obj.data?.items) {
    ...
    */  
    ...
    const upnamekeywordsToMatch = ["今日", "MrBeast", "黑科技", "徐涛", "考研", "金铲铲", "野球帝", "漫剪", "JOJO", "Python", "漫威", "爱动漫", "说动漫", "说考研", "华强北", "神超"]
    obj.data.items = obj.data.items.filter((i) => {
      ...
      if (cardType && cardGoto) {
        if (
          ...
          (up_name && ["Miss_韩懿莹", "胖龙的小生活", "指法芬芳张大仙", "今日话题君", "网不红萌叔Joey", "今日话题酱", "华为", "兔叭咯", "蒸気火鸡", "上汽大众", "敬汉卿", "你果汁分我一半", "jova_h", "-欣小萌有点亏-", "宋浩老师官方", "原神", "徐涛政治课堂", "子源动漫", "吃不饱三战士", "云顶之弈\-套路王\-七七", "白粥不黑不白", "LPL梗百科", "李不白磨针", "PT健身华哥", "小红毛来辣", "云顶芝士", "炉石Kimmy", "狂野saiwei", "矮矮的桔子", "o冷月追风oO", "小凌漆漆", "大大怪怪怪将军", "我是TOO", "硬汉形象26", "黑黑黑黑莲", "佐助Sama", "炉石萌萌哒的狗贼", "uTools", "老实憨厚的笑笑", "莴苣某人", "22林酱", "小鱼一图流", "林小北Lindo", "鲁大能", "牛牛牛牛牛牛弟", "炉石传说瓦莉拉", "兰林汉的粉丝", "一数", "云顶王天师", "我是小河灵", "阿助今天有工资吗", "小紧张的虫虫", "往往老布", "云顶丶小白", "单走一张六", "你的影月月", "炉石涛妹", "柳岩LIUYAN", "何胜0423", "云顶魔术师黄莲", "铠甲勇士-奥飞", "文森特", "我是瑞斯拜", "空卡空卡空空卡", "考研竞赛凯哥", "黑马程序员", "考研数学武忠祥老师", "姜云升", "高冷难神衣锦夜行", "炉石东少", "犬狐狸", "哔哩哔哩英雄联盟赛事", "云顶小莫", "春哥再就业", "图灵学院教程", "学过石油的语文老师", "幻灭究极老粉", "张圣叹Yo", "痞大菠萝派", "Roy大表哥", "IGN中国", "阿泽u稻草人", "谁让我是白泽呢", "笛木清", "剑客范十三", "芜湖小佐助", "佰鹤羽", "-欣小萌-", "王师傅和小毛毛", "侯翠翠" /* Add more up_name values here */].includes(up_name)) ||
