...
if (url.includes("/x/resource/show/skin")) {
  ...
  if (obj.data?.items) {
    ...
    */  
    ...
    const upnamekeywordsToMatch = ["指法芬芳张大仙", "MBTI", "official", "漫威", "科幻", "动画官方", "金铲铲", "数学教师", "Excel", "星穹铁道", "Official", "补番", "微软", "明天", "EPIC", "Epic", "epic", "一纸荒唐言", "飓多多", "话题", "小砍", "每日", "今日", "MrBeast", "黑科技", "徐涛", "考研", "金铲铲", "野球帝", "漫剪", "JOJO", "Python", "漫威", "爱动漫", "说动漫", "说考研", "华强北", "神超"]
